...
import 'package:meine_zeiterfassungs_app/src/features/screens/Users/ItemModel/user_item.dart';
...
class _MitarbeiterScreenState extends State<MitarbeiterScreen> {
  ...
  void createEmployers() {
    Users user =
        Users(userId: '', firstName: _firstNameController.text, lastName: _lastNameController.text, isAdmin: false);
